...
def total_contribution(v_list, w0, T,
    ...
    q_e, S_e, H_e = electronic_contributions(w0 = w0)
    q_v, S_v, H_v = vibrational_contribution(v_list = v_list, 
                                             T = T)
    q_r, S_r, H_r = rotational_contirubution(molecule = molecule, 
                                             sigma = sigma,
                                             T = T, 
                                             linear = linear)
    q_t, S_t, H_t = translational_contribution(molecule = molecule, 
                                               T = T, 
                                               P = P,
                                               M = M)
